...
//default constructor
	...
	/**
	 * This method accepts adminName and password as input and checks that whether it is available in the adminList
	 * it returns true if exists  otherwise return false
	 * @param adminName
	 * @param password
	 * @return
	 * @throws Exception 
