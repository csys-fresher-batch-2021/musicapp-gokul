...
/**
 * Servlet implementation class GetSongImageServlet
 */
@WebServlet("/GetSongImageServlet")
public class GetSongImageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetSongImageServlet() {
        super();
